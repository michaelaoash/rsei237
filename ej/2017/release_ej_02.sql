...
DROP TABLE IF EXISTS release_ej_2017 ;
CREATE TABLE release_ej_2017
...
FROM ashm_rsei237gma.release_ej_2017_cell
GROUP BY ReleaseNumber ;

CREATE INDEX ReleaseNumber ON release_ej_2017 (ReleaseNumber) ;
